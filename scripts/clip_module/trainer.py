...
class Trainer:
    ...
    def train(self):
        ...
        # Save models
        self.save_model(self.encoder, 'saved_models/bs_encoder_weights_test.pth')
        self.save_model(self.projector, 'saved_models/txt_proj_weights_test.pth')
        self.save_model(self.decoder, 'saved_models/bs_decoder_weights_test.pth')