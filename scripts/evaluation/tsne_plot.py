...
from clip_module.model import BlendshapeEncoder, TextProjector, ClipEncoderModule, BlendshapeDecoder
...
device = "cuda:0"  # Use the same device you had in your original code

# Model paths
bs_encoder_path = './clip_module/saved_models/bs_encoder_weights_200ep_augmented.pth'  
text_proj_path = './clip_module/saved_models/txt_proj_weights_200ep_augmented.pth'
bs_decoder_path = './clip_module/saved_models/bs_decoder_weights_200ep_augmented.pth'

df = pd.read_csv('../gen_data/dataset_with_BS.csv')
        
# Print dataframe info for debugging
print(f"DataFrame loaded: {len(df)} rows, columns: {df.columns.tolist()}")

# Sample data for faster processing
sample_df = df.sample(n=10000, random_state=42) # 5000 pontos no plot
...
decoded_blendshapes = generator.create_arrow_paths(
    ...
    save_path='evaluation/tsne_plots/tsne_plot_10000_points.png',
